...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-11-2022 a las 19:27:29
...
INSERT INTO `horarios` (`id`, `dia`, `horaInicio`, `horaFin`, `idParqueadero`) VALUES
(1, 'L', '08:00:00', '20:00:00', 14),
(2, 'M', '08:08:08', '21:09:09', 16),
(3, 'M', '10:17:20', '12:30:14', 15);
...
CREATE TABLE `parqueaderos` (
  ...
  `modoDeControl` char(1) DEFAULT NULL,
...
INSERT INTO `parqueaderos` (`id`, `nombre`, `clase`, `direccion`, `longitud`, `latitud`, `modoDeControl`, `capacidad`, `idPersona`, `idCiudad`) VALUES
(14, 'Parqueadero de prueba', 'A', 'Calle 15 No 20-15', '10', '33', 'T', 6, 26, 11),
(15, 'Parqueadero el chavo', 'A', 'Calle 8 No 88-08', '8', '808', 'T', 35, 27, 90),
(16, 'La bestia', 'A', 'Carrera 6 No 6-6', '66', '6666', 'T', 66, 28, 15),
(18, 'Parqueadero el chavo', 'A', 'Calle 8 No 88-08', '88', '88888', 'T', 8, 30, 10);
...
INSERT INTO `parqueos` (`id`, `placa`, `fechaHoraIngreso`, `fechaHoraSalida`, `codigoBarra`, `idTipoVehiculo`, `idParqueadero`) VALUES
(1, 'wze93c', '2022-10-24 13:09:11', NULL, 'T', 2, 15);
...
INSERT INTO `personas` (`id`, `tipoIdentificacion`, `numIdentificacion`, `nombres`, `apellidos`, `telefono`, `email`, `fechaNacimiento`, `clave`, `tipo`, `usuario`) VALUES
(1, 1, 0, 'Administrador', 'del Sistema', '5555555', 'admin@gmail.com', NULL, '123', 'a', 'admin'),
(3, 2, 87066476, 'Jhonny Orlando', 'Guerrero Matabanchoy', '3163601029', 'jhorguma@gmail.com', '1984-08-18', '123', 'C', 'jhogue8487'),
(26, 1, 1085315112, 'Ana del Rosario', 'Martinez', '30011223344', 'anamartinez@gmail.com', '1992-10-04', '123', '', 'anamar'),
(27, 1, 8, 'Chavo', 'del ocho', '888', 'chavo@del8.com', '1998-08-08', '123', '', 'chavo'),
(28, 1, 6, 'number of', 'beast', '666', '666@gmail.com', '2006-06-06', '8b958c492e4176ee946c8ffaeeabdc93', '', 'best'),
(29, NULL, 123456, 'Pepito', 'Perez', NULL, 'correo@gmail.com', '2022-10-25', '123', 'a', 'pp'),
(30, 1, 8, 'Chavo', 'del ocho', '8', '8@gmail.com', '2021-07-27', 'a6e0cd0b38a1b1f2a3541c66ae90df2d', 'A', NULL);
...
INSERT INTO `tipovehiculos` (`id`, `tipoVehiculo`) VALUES
(1, 'Moto'),
(2, 'Automovil'),
(3, 'Camioneta'),
(4, 'CuatriMoto'),
...
ALTER TABLE `ciudades`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ciudades_FKIndex1` (`idDepartamento`);
...
ALTER TABLE `horarios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `horarios_FKIndex1` (`idParqueadero`);
...
ALTER TABLE `parqueaderos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `parqueaderos_FKIndex1` (`idPersona`),
  ADD KEY `parqueaderos_FKIndex2` (`idCiudad`);
...
ALTER TABLE `parqueos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `parqueos_FKIndex1` (`idParqueadero`),
  ADD KEY `parqueos_FKIndex2` (`idTipoVehiculo`);
...
--
ALTER TABLE `ciudades`
  ADD CONSTRAINT `ciudades_ibfk_1` FOREIGN KEY (`idDepartamento`) REFERENCES `departamentos` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `horarios`
--
ALTER TABLE `horarios`
  ADD CONSTRAINT `horarios_ibfk_1` FOREIGN KEY (`idParqueadero`) REFERENCES `parqueaderos` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `parqueaderos`
--
ALTER TABLE `parqueaderos`
  ADD CONSTRAINT `parqueaderos_ibfk_1` FOREIGN KEY (`idPersona`) REFERENCES `personas` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `parqueaderos_ibfk_2` FOREIGN KEY (`idCiudad`) REFERENCES `ciudades` (`id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `parqueos`
--
ALTER TABLE `parqueos`
  ADD CONSTRAINT `parqueos_ibfk_1` FOREIGN KEY (`idParqueadero`) REFERENCES `parqueaderos` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `parqueos_ibfk_2` FOREIGN KEY (`idTipoVehiculo`) REFERENCES `tipovehiculos` (`id`) ON UPDATE CASCADE;
COMMIT;
